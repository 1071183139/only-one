...
SECRET_KEY = 'k8bq+tg@e9#(m@8s48=-20+u_#ph#md^hnoauvffeovy&1z_6$'
...
# 认证系统使用的用户模型
# AUTH_USER_MODEL = "apps.users.User" Django只
# 支持模块和类名之间用.分隔，多了一个点就解析不出来
...
FASTDFS_URL = "http://http://192.168.44.133:8888/"
